...
export class DashboardComponent implements OnInit {
  ...
  picture: any = [
    ...
    { id: 2, imgUrl: '../../assets/images/Dish/Burgers.png', name: 'Burger' },

    { id: 4, imgUrl: '../../assets/images/Dish/chicken.png', name: 'Chicken' },

    { id: 7, imgUrl: '../../assets/images/Dish/noodles.png', name: 'Noodle' },
    { id: 8, imgUrl: '../../assets/images/Dish/Paneer.png', name: 'Paneer' },
    { id: 9, imgUrl: '../../assets/images/Dish/Pizza.png', name: 'Pizza' },
    { id: 10, imgUrl: '../../assets/images/Dish/rolls.png', name: 'Rolls' },

    { id: 12, imgUrl: '../../assets/images/Dish/thali.png', name: 'Thali' },
  ];
  Brand: any = [
    {
      id: 1,
    ...
    { id: 3, imgUrl: '../../assets/images/Brand/KFC.png', name: 'KFC' },
    {
      id: 4,
    ...
    { id: 6, imgUrl: '../../assets/images/Brand/Meraki.png', name: 'Meraki' },
    {
      id: 7,
      imgUrl: '../../assets/images/Brand/Pizza Hut.png',
      name: 'Pizza Hut',
    },
    { id: 8, imgUrl: '../../assets/images/Brand/Subway.png', name: 'Subway' },
  ];
  restro: any = [
    {
      id: 1,
